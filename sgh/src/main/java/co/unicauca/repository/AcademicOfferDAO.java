...
public class AcademicOfferDAO {
	...
	public void addOffer(AcademicOffer objAcademicOffer) {
		...
		professors.add(new Professor(objAcademicOffer.getCodProfessor(), objAcademicOffer.getNameProfessor(), objAcademicOffer.getCodDepartament()));
		groups.add(new Group(objAcademicOffer.getCodCourse(), objAcademicOffer.getCodProfessor(), objAcademicOffer.getGroup()));
		
	}
	
	public void addInfraestructure(Infraestructure objInfraestructure) {
		infraList.add(objInfraestructure);
		academicAmbients.add(new AcademicAmbient(objInfraestructure.getNumber(), objInfraestructure.getCodFaculty(), objInfraestructure.getNumber(),
				objInfraestructure.getUbication(), objInfraestructure.getMaxCapacity(), objInfraestructure.getDescription()));
		resources.add(new Resource(objInfraestructure.getSerial(), objInfraestructure.getNumber(), objInfraestructure.getNameResource(), objInfraestructure.getDescription()));
	}
